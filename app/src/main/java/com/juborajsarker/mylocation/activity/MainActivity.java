...
import com.juborajsarker.mylocation.fragment.LocationFragment;
import com.juborajsarker.mylocation.fragment.NearbyFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void shareApp(MenuItem item) {
        ...
        intent.setType("*/*");
        intent.createChooser(intent, "My Location");
        intent.putExtra(Intent.EXTRA_STREAM, Uri.fromFile(new File(filePath)));
        startActivity(Intent.createChooser(intent, "share My Location using"));
